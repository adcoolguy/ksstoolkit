...
public class LibgdxImageConverter extends ConverterBase implements
		FileWatcherCallback {
	...
	LibgdxConverter c1 = new LibgdxConverter();
	
	public LibgdxImageConverter() {
		super();
	}
	...
	public LibgdxConverter getC1() {
		return c1;
	}

	public void setC1(LibgdxConverter c1) {
		this.c1 = c1;
	}
...
//			targetStory = "HPDemo.story";
			Graphics.initResolution(704, 480); // TBD - should not have to do it!!!
...
//		File("./script/java/wireframe").getAbsolutePath(), new
//		LibgdxImageConverter());
		LibgdxImageConverter img = new LibgdxImageConverter();
		try {
			img.processModify();
		} catch (Exception e) {
			e.printStackTrace();
