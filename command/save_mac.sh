...
echo saving '${PROJECT_HOME}/ksstoolkit/.classpath' to '${PROJECT_HOME}/ksstoolkit/command/.classpath.mac' ...
cp -f ${PROJECT_HOME}/ksstoolkit/.classpath ${PROJECT_HOME}/ksstoolkit/command/.classpath.mac
